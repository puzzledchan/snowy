...
int CreateUDPSocket() { return ::socket(AF_INET, SOCK_DGRAM, IPPROTO_UDP); }
...
in_addr_t GetLocalAddrInfo() {
  ...
  fprintf(stderr,
          "GetLocalAddrInfo can't work on MAC OS, return 127.0.0.1 instead\n");
  struct in_addr pin;
